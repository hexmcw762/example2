...
@Configuration
@MapperScan(basePackages = "com.iot.shop.**.mapper")
...
public class DatabaseConfig {
	...
	public SqlSessionFactory sqlSessionFactory(DataSource datasource) throws Exception {
		...
		sqlSessionFactory.setConfigLocation(applicationContext.getResource("classpath:com/iot/shop/common/Mybatis-Config.xml"));
